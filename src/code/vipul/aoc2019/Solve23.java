    ...
    public static void solve() {
        ...
        while(true) {
            ...
            for (int i = 0; i < TOTAL_COMPUTERS; i++) {
                ...
                List<Long> outputs = computer.getOutput().getOutputs();
                ...
                if (!outputs.isEmpty()) {
                    ...
                    for (int j = 0; j < outputs.size(); j+=3) {
                        ...
                        computers[address].getInput().enqueueInputContinuous(Arrays.asList(x, y));
                    }
            ...
            for (int i = 0; i < TOTAL_COMPUTERS; i++) {
                boolean isBitSet = (map & (1L << i)) != 0;
                Computer computer = computers[i];
                if (!isBitSet && !computer.getInput().hasUnflushedInput()) {
                    computer.getInput().enqueueInputContinuous(Collections.singletonList(-1L));
                }
            }
        ...
        System.out.println("Answer: " + answer); // 20160
    }

    public static void solvePart2() {
        long natX = -1, natY = -1, prevYSent = -1;
        ...
        while(true) {
            ...
            for (int i = 0; i < TOTAL_COMPUTERS; i++) {
                if (computers[i].getInput().hasUnflushedInput()) {
                    isNetworkIdle = false;
                    break;
                }
            }

            if (isNetworkIdle && natX != -1) {
                boolean isYSameAsPrevY = natY == prevYSent;
                if (isYSameAsPrevY) {
                    answer = natY;
                    break;
                }
                ...
                prevYSent = natY;
                computers[0].getInput().enqueueInputContinuous(Arrays.asList(natX, natY));
            }
        ...
        System.out.println("Answer: " + answer); // 13164
    }
}
